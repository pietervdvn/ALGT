...
$$($$STFL.language![0..90],[104..112] $$examples.stfl!3 expr -l -r →)![10..]
...
$$($$STFL.language![0..90],[99..112] $$examples.stfl!6,7 expr -l -r →)![10..]
...
$$($$STFL.language![0..112] $$examples.stfl!4 expr -l -r →)![10..]


As a bonus, it'll also solve our `1 + 2 + 3`! 

$$($$STFL.language![0..112] $$examples.stfl!7 expr -l -r →)![10..]
...
$$($$STFL.language![0..115] $$examples.stfl!8 expr -l -r →)![10..]
...
$$($$STFL.language![0..140] $$examples.stfl!1 expr -l -r →*)![10..]
$$($$STFL.language![0..140] $$examples.stfl!2 expr -l -r →*)![10..]
$$($$STFL.language![0..140] $$examples.stfl!3 expr -l -r →*  --short-proofs 4)![10..]

$$($$STFL.language![0..140] $$examples.stfl!5 expr -l -r →*)![10..]
$$($$STFL.language![0..140] $$examples.stfl!6 expr -l -r →* --short-proofs 4)![10..]
$$($$STFL.language![0..140] $$examples.stfl!7 expr -l -r →* --short-proofs 4)![10..]
$$($$STFL.language![0..140] $$examples.stfl!8 expr -l -r →* --short-proofs 1)![10..]


Building the typechecker
------------------------

Now that this is done, we can slay the next dragon: the typechecker!
