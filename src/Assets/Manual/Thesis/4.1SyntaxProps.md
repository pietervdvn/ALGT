...
When a parsetree is given, we want to be able to pinpoint exactly which syntactic form parsed it, as this can be used to minimize the set representation later on. A syntax should thus not contain duplciate sequences.
