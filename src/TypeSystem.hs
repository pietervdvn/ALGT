...
checkRules	:: Syntax -> Rules -> Either String ()
checkRules syntax (Rules rules)
	= rules & M.elems & concat |> typeCheckRule syntax & allRight_
...
typeCheckConclusion bnfs (RelationMet relation exprs)
